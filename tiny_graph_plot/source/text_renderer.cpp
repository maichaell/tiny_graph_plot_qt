...
TextRenderer::TextRenderer(QOpenGLContext* context) :
...
void TextRenderer::DrawSingle(const size_t i_label) {
...
void TextRenderer::SendToGPU(void) {
...
void TextRenderer::SendToGPUverticesSingle(const size_t i_label) {
...
void TextRenderer::SendToGPUtextureSingle(const size_t i_label) {
